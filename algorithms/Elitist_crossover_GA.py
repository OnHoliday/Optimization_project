...
class GeneticAlgorithm(RandomSearch):
    ...
    def search(self, n_iterations, probability, report=False, log=False, dplot=None):
        if log:
        ...
        for iteration in range(n_iterations):
            ...
            while len(offsprings) < len(self.population):
                ...
                if self._random_state.uniform() < self.p_c:
                    ...
                    if self._random_state.uniform() < probability:
    ...
    def _phenotypic_diversity(self,population):
        solutions = []
