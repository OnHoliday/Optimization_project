...
from algorithms.genetic_algorithm_geometric import GeneticAlgorithm
#from algorithms.GA_with_plotting import GeneticAlgorithm
...
ga = GeneticAlgorithm(ann_op_i, random_state, ps, uls.parametrized_tournament_selection(pressure),
                      uls.geometric_crossover_michalewicz, p_c, uls.parametrized_ball_mutation(radius), p_m)
ga.initialize()
